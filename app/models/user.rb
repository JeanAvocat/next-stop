class User < ApplicationRecord
  ...
  has_many :chifoumi_games_as_first_player, foreign_key: :first_player_id, class_name: "ChifoumiGame"
  has_many :chifoumi_games_as_second_player, foreign_key: :second_player_id, class_name: "ChifoumiGame"
